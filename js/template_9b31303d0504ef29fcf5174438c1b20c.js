...
function dual_switch_toggle(sw) {
	...
	if (sw.closest('.filter_field').attr('rel') == 'elite_type' || sw.closest('.filter_field').attr('rel') == 'comm_type') {
...
function dual_switch_change(inp) {
	...
	parent.find('.dual_switch').removeClass('sel');
	if (inp.closest('.filter_field').attr('rel') == 'elite_type' || inp.closest('.filter_field').attr('rel') == 'comm_type') {
		switch_type=inp.closest('.filter_field').attr('rel');
		var val = $('#filter_form input[name=filter_'+switch_type+']').val();
...
function dual_switch_type(sw, type) {
	...
	$('#filter_form input[name=filter_'+switch_type+']').val(type);
}
